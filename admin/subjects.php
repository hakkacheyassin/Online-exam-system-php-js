                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myPillTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active show" id="home-icon-pill" data-toggle="pill" href="#addPIll" role="tab" aria-controls="homePIll" aria-selected="true">Add Subjects</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-icon-pill" data-toggle="pill" href="#mngPIll" role="tab" aria-controls="profilePIll" aria-selected="false">Manage Subjects</a>
                                </li>
                           ...
                           <div class="card mb-5">
                        <div class="card-body">
                            <form action="app/add-subjects.php" method="POST" autocomplete="OFF">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Subject Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" required name="name" class="form-control" id="inputEmail3" placeholder="Enter subject name">
                                    </div>
                                </div>
                           ...
                           <div class="table-responsive">
                                <table id="zero_configuration_table" class="display table table-striped table-bordered" style="width:100%">
                                    ...
                                    $stmt = ("SELECT a.*, b.*, c.* FROM tbl_subjects a LEFT JOIN tbl_departments b ON a.department = b.id LEFT JOIN tbl_classes c ON a.class = c.id");
                                    $result = mysqli_query($conn,$stmt);
                                    ...
                                    <?php while($row = mysqli_fetch_array($result)): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit-subject?node=<?php echo $row[0]; ?>" title="Edit" class="text-success mr-2">
                                                            <i class="nav-icon i-Pen-2 font-weight-bold"></i>
                                                </a>
                                                <a onclick="return confirm('Are you sure you want to delete ?')" title="Delete" href="app/drop-subject.php?node=<?php echo $row[0]; ?>" class="text-danger mr-2">
