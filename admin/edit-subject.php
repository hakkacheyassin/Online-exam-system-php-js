...
$stmt = ("SELECT a.*, b.*, c.* FROM tbl_subjects a LEFT JOIN tbl_departments b ON a.department = b.id LEFT JOIN tbl_classes c ON a.class = c.id WHERE a.id = $subject_id");
...
<head>
    ...
    <title>OES - Edit <?php echo $subject_name; ?></title>
    ...
    <div class="app-admin-wrap">
        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            <div class="breadcrumb">
                <h1>Edit <?php echo $subject_name; ?></h1>
            ...
            <div class="separator-breadcrumb border-top"></div>
             <div class="row mb-4">
                <div class="col-md-12 mb-4">
                           ...
                           <div class="card mb-5">
                        <div class="card-body">
                            <form action="app/edit-subjects.php" method="POST" autocomplete="OFF">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Subject Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" value="<?php echo $subject_name; ?>" required name="name" class="form-control" id="inputEmail3" placeholder="Enter subject name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select onchange="update(this.value)" required name="department" class="form-control" >
                                            ...
                                            {
                                                print '<option'; if ($dep_id == $row[0]) { print ' selected ';} print ' value="'.$row[0].'">'.$row[1].'</option>';
