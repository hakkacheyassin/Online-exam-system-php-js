...
if (isset($_GET['node'])) {
    ...
    if(!$conn)
    {
        echo "result " . mysqli_connect_error();
    }

    
    $stmt = "SELECT * FROM tbl_exams WHERE exam_id = '$exam_id'";
    ...
    <div class="app-admin-wrap">
        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            <div class="breadcrumb">
                <h1>Add Questions - <?php echo $exam_name; ?></h1>
                <p id="app_data"></p>
                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myPillTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active show" id="home-icon-pill" data-toggle="pill" href="#addPIll" role="tab" aria-controls="homePIll" aria-selected="true">Multiple Choice Questions</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-icon-pill" data-toggle="pill" href="#mngPIll" role="tab" aria-controls="profilePIll" aria-selected="false">Filling Blank Space Questions</a>
                                </li>
                           ...
                           <div class="card mb-5">
                        <div class="card-body">
                            <form action="app/add-question.php" method="POST" autocomplete="OFF">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Question</label>
                                    <div class="col-sm-10">
                                        <input type="text" required name="question" class="form-control" id="inputEmail3" placeholder="Enter question">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" required name="op1" class="form-control" id="inputEmail3" placeholder="Enter first option">
                                    </div>

                                    <div class="col-sm-2">
                                    <label class="radio radio-outline-primary">
                                    <input type="radio" name="answer" value="op1" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" required name="op2" class="form-control" id="inputEmail3" placeholder="Enter second option">
                                    </div>

                                    <div class="col-sm-2">
                                    <label class="radio radio-outline-primary">
                                    <input type="radio" name="answer" value="op2" required>
                                    <span>Mark as answer</span>
                                    <span class="checkmark"></span>
                                    </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" required name="op3" class="form-control" id="inputEmail3" placeholder="Enter third option">
                                    </div>

                                    <div class="col-sm-2">
                                    <label class="radio radio-outline-primary">
                                    <input type="radio" name="answer" value="op3" required>
                                    <span>Mark as answer</span>
                                    <span class="checkmark"></span>
                                    </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" required name="op4" class="form-control" id="inputEmail3" placeholder="Enter fourth option">
                                    </div>

                                    <div class="col-sm-2">
                                    <label class="radio radio-outline-primary">
                                    <input type="radio" name="answer" value="op4" required>
                                    <span>Mark as answer</span>
                                    <span class="checkmark"></span>
                                    </label>
                                    </div>
                        ...
                        <div class="card-body">
                            <form action="app/add-question.php" method="POST" autocomplete="OFF">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" required name="answer" class="form-control" id="inputEmail3" placeholder="Enter answer">
                                    </div>
