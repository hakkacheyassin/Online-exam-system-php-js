                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myPillTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active show" id="home-icon-pill" data-toggle="pill" href="#addPIll" role="tab" aria-controls="homePIll" aria-selected="true">Add Classes</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-icon-pill" data-toggle="pill" href="#mngPIll" role="tab" aria-controls="profilePIll" aria-selected="false">Manage Classes</a>
                                </li>
                           ...
                           <div class="card mb-5">
                        <div class="card-body">
                            <form action="app/add-class.php" method="POST" autocomplete="OFF">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Class Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" required name="name" class="form-control" id="inputEmail3" placeholder="Enter class name">
                                    </div>
                                </div>
                           ...
                           <div class="table-responsive">
                                <table id="zero_configuration_table" class="display table table-striped table-bordered" style="width:100%">
                                    ...
                                    $stmt = "SELECT * FROM tbl_classes LEFT JOIN tbl_departments ON tbl_classes.department = tbl_departments.id";
                                    $result = mysqli_query($conn,$stmt);
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Are you sure you want to delete ?')" title="Delete" href="app/drop-class.php?node=<?php echo $row[0]; ?>" class="text-danger mr-2">
                                             ...
                                             <div class="modal-body">
                                              <form action="app/update-class.php" method="POST" autocomplete="OFF">
                                              <div class="form-group row">
                                              <label for="inputEmail3" class="col-sm-4 col-form-label">Class Name</label>
                                              <div class="col-sm-7">
                                              <input type="text" value="<?php echo $row[1]; ?>" required name="name" class="form-control" id="inputEmail3" placeholder="Enter class name">
                                            ...
                                            $stmtb = ("SELECT * FROM tbl_departments ORDER BY name");
                                            $resultb = mysqli_connect($conn,$stmtb); 
                                           

                                            while($rowb = mysqli_fetch_array($resultb))
                                            {
                                                print '<option'; if ($rowb[1] == $row[5]) { print ' selected ';} print ' value="'.$rowb[0].'">'.$rowb[1].'</option>';
