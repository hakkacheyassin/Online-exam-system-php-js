                    ...
                    <div class="card text-left">
                        <div class="card-body">
                                ...
                                <table id="zero_configuration_table" class="display table table-striped table-bordered" style="width:100%">
                                    ...
                                    $stmt = $conn->prepare("SELECT a.*, b.*, c.*, d.* FROM tbl_exams a LEFT JOIN tbl_departments b ON a.department = b.id LEFT JOIN tbl_classes c ON a.class = c.id LEFT JOIN tbl_subjects d ON a.subject = d.id WHERE a.class = :myclass");
                                    ...
                                    foreach($result as $row)
                                    {
                                        if ($row['fee'] == "") {
                                            ...
                                            $fee = ''.number_format($row['fee']).' '.$currency.'';
                                        }
                                        ?>
                                        <tr>
                                           ...
                                           data-content="Exam ID : <?php echo $row[0]; ?> , Duration : <?php echo $row[2]; ?> Minutes , Passmark : <?php echo $row[3]; ?>% , Re-take exam after <?php echo $row[4]; ?> Days" data-original-title="" title=""><?php echo $row[1]; ?></a>
                                            ...
                                            <option value="view-exam?node=<?php echo $row[0]; ?>">Take Exam</option>
                                            </select>
                                            </center>
